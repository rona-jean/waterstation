...
<div class="page-container">
  ...
  <div class="product-card" style="border: 1px solid #ddd; border-radius: 8px; padding: 15px; width: 220px; background: #fff;">
    ...
    <?php else: ?>
      <?php
$is_guest = !isset($_SESSION['role']) || $_SESSION['role'] !== 'user';

if ($is_guest): ?>
    <form method="POST" action="guest_checkout.php" style="margin-top: 10px;">
        ...
        <button type="submit" name="buy_now" style="margin-left: 10px;">Buy Now</button>
    </form>
    <?php else: ?>
